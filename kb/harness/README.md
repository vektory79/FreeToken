...
переиспользуются между кампаниями. **Карточки использования каждого скрипта
(что запускается, с какими аргументами, готчи) — в README.md соответствующего
подкаталога; ниже роль каждого подкаталога и ключевые входы.**
...
| [ab-runner/](ab-runner/README.md) | A/B-машинерия dense q8_0: свипы mtile/nsplit, арбитраж, микробенчмарки, VRAM-headroom, параметризованный stage-раннер |
| [mmq/](mmq/README.md) | A/B и анализ MMQ: v0/v2 пробы и анализаторы, step0-запуск/разбор, v3a stage и батарея, проба живости |
| [quality/](quality/README.md) | Батарея качеств: запуск прогонов и разбор дивергенции |
...
дальше. Общие готчи прогонов (skip times[0] SSE, якорь строки
