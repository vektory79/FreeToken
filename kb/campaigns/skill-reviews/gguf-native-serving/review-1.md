...
- Минимальный фикс: в SKILL.md заменить упоминания на явные ссылки относительно местоположения SKILL.md: `[ORCHESTRATION.md](ORCHESTRATION.md)`, `[TRAPS.md](TRAPS.md)`, и по одной ссылке на каждый бриф: `[tasks/task-00-discovery.md](tasks/task-00-discovery.md)` ... `[tasks/task-07-cpu-compute-tier.md](tasks/task-07-cpu-compute-tier.md)` (в т.ч. раскрыть диапазонные записи "task-00..07" / "task-0N-*.md" в список из 8 ссылок).
